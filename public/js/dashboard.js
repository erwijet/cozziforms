...
function setupHandlers() {
  $('#items-tab').on('click', function (e) {
    return setAdminMode(ADMIN_MODE.Items);
  });
  $('#vendors-tab').on('click', function (e) {
    return setAdminMode(ADMIN_MODE.Vendors);
  });
  $('#users-tab').on('click', function (e) {
    return setAdminMode(ADMIN_MODE.Users);
  });
  $('#iim-deleteBtn').on('click', function (e) {
    $('#inspectItemModal').removeClass('is-active');
  });
  $('#searchboxTxt').on('change', function (e) {
    var _$$val$toString, _$$val;

    var query = (_$$val$toString = (_$$val = $('#searchboxTxt').val()) === null || _$$val === void 0 ? void 0 : _$$val.toString()) !== null && _$$val$toString !== void 0 ? _$$val$toString : '';
    populateItemList(new RegExp(query));
  });
  console.log($('#newitemBtn'));
  $('#newitemBtn').on('click', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              stateChanged = function _stateChanged(e) {
                // called any time the vendor select or name textbox is changed
                var vendorIsSelected = $('#iim-vendorSelect').prop('selectedIndex') != 0;
                var nameIsSelected = $('#iim-itemnameTxt').val() != '';
            ...
            case 3:
              $('#iim-vendorSelect').prepend($('<option value="" disabled>Select a Vendor</option>')).prop('selectedIndex', 0).on('change', stateChanged);
              ...
              $('#iim-saveBtn').on('click', /*#__PURE__*/function () {
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          idx = $('#iim-vendorSelect').prop('selectedIndex');
                          vendor = $(`#iim-vendorSelect option:nth-child(${idx + 1})`).attr('vendorid');
                          _context.next = 4;
                          return (0, _items.updateItem)(item._id.toString(), {
...
function _populateVendorSelect() {
  _populateVendorSelect = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            vendorSelect = $('#iim-vendorSelect');
            vendorSelect.empty();
            vendors.forEach(function (vendor) {
              $('<option>').text(vendor.name).attr('vendorId', vendor._id).appendTo(vendorSelect);
...
function launchEditItemModal(_x3) {
  return _launchEditItemModal.apply(this, arguments);
}
/**
...
function _launchEditItemModal() {
  _launchEditItemModal = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(item) {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            $('#inspectItemModal').addClass('is-active'); // remove any old click handlers

            $('#iim-saveBtn').off('click'); // define item update routine
...
function appendItemToTable(item) {
  var _item$vendor$name, _item$vendor, _item$category$name, _item$category;

  var itemTableBody = $('#itemTable').find('tbody');
  var newRow = $('<tr>').attr('itemid', item._id).on('click', function (e) {
    launchEditItemModal(item);
  });
  [$('<td>').text((_item$vendor$name = (_item$vendor = item.vendor) === null || _item$vendor === void 0 ? void 0 : _item$vendor.name) !== null && _item$vendor$name !== void 0 ? _item$vendor$name : 'mdb population err'), $('<td>').html((_item$category$name = (_item$category = item.category) === null || _item$category === void 0 ? void 0 : _item$category.name) !== null && _item$category$name !== void 0 ? _item$category$name : '<span class="tag">No Category</span>'), $('<td>').text(item.name)].forEach(function (elem) {
    return elem.appendTo(newRow);
  });
  newRow.appendTo(itemTableBody);
}

function populateItemList(_x4) {
  return _populateItemList.apply(this, arguments);
}

function _populateItemList() {
  _populateItemList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(regex) {
...
},{"./helper/items":2,"./helper/vendors":3}],2:[function(require,module,exports){
"use strict";
...
function _updateItem() {
  _updateItem = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(itemId, fields) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
function createItem(_x4, _x5) {
  return _createItem.apply(this, arguments);
}

function _createItem() {
  _createItem = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, vendorId) {
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
